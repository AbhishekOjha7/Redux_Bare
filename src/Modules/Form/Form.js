import { View, Text, SafeAreaView, StyleSheet, TextInput, Modal,TouchableOpacity, FlatList, Alert, Image } from 'react-native'
...
const Form = () => {
    ...
    const { data } = useSelector((store) => store.FormReducer);
         ...
         if(button=='Add Details'){
            ...
            if (data.length > 0) {
                ...
                if (i < 0) {
                    ...
                    dispatch({type: 'Add Details',payload})
             ...
             data[index].nam=name;
             data[index].emai=email;
             let payload = {data}
             dispatch({type:"Update Details", payload:payload})
                    ...
                    renderItem={( {item, index} ) => {
                        ...
                        return (
                            <View style={styles.card}>
                                <Text style={styles.namedesign}>Name:{item.nam}</Text>
                                <Text style={styles.emaildesign}>Email:{item.emai}</Text>
                                <TouchableOpacity
                                    onPress={() => {
                                    ...
                                    style={styles.delete}>
                                    <Image style={styles.deleteicon} source={require('/Users/admin/Desktop/ReactNative/ReduxBare/src/assets/images/delete.png')} />
                                </TouchableOpacity>
                                ...
                                <TouchableOpacity onPress={()=>{
                                  ...
                                  setName(data[i].nam);
                                  setEmail(data[i].emai);
                                  setDisabled1(false);
                                  setDisabled2(false)
                                }} style={styles.edit}>
                                    <Image style={styles.editicon} source={require('/Users/admin/Desktop/ReactNative/ReduxBare/src/assets/images/edit.png')} /> 
                                </TouchableOpacity>
                            </View>
                        )
                    }}
